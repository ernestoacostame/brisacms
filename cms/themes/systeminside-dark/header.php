...
/* ── HEADER ── */
.site-header { background: var(--header-bg); position: sticky; top: 0; z-index: 200; border-bottom: 2px solid #1a1a1a; }
...
.logo-main  { font-family: var(--font); font-size: 1.75rem; font-weight: 700; color: #fff; letter-spacing: -0.02em; text-transform: uppercase; }
...
.hamburger span { display: block; width: 24px; height: 2px; background: #aaa; transition: all 0.25s; }
.hamburger.open span:nth-child(1) { transform: translateY(7px) rotate(45deg); }
.hamburger.open span:nth-child(2) { opacity: 0; }
.hamburger.open span:nth-child(3) { transform: translateY(-7px) rotate(-45deg); }

/* ── NAV DROPDOWN ── */
.nav-dropdown { background: #0a0a0d; border-bottom: 2px solid var(--accent); overflow: hidden; max-height: 0; transition: max-height 0.3s ease; position: fixed; top: 56px; left: 0; right: 0; z-index: 300; }
...
.nav-list a { color: #888; text-decoration: none; font-family: var(--font); font-size: 0.95rem; text-transform: uppercase; letter-spacing: 0.04em; padding: 0.4rem 0.85rem; border-radius: 3px; transition: all 0.15s; display: block; }
...
.search-bar form { display: flex; background: var(--surface); border: 1px solid var(--border2); border-radius: 3px; overflow: hidden; }
...
.search-bar button { background: none; border: none; padding: 0 0.85rem; cursor: pointer; color: var(--muted); display: flex; align-items: center; transition: color 0.15s; }
...
.widget-title { background: transparent; color: #555; font-family: var(--font); font-size: 1.1rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; padding: 0.85rem 1rem 0.4rem; }
.widget-body { padding: 0.25rem 1rem 0.85rem; }
.cat-list { list-style: none; }
.cat-list li { padding: 0.1rem 0; }
...
/* ── FOOTER ── */
.site-footer { background: var(--header-bg); border-top: 2px solid #1a1a1a; margin-top: 2rem; padding: 2rem 1.5rem; text-align: center; }
.footer-inner { max-width: 1200px; margin: 0 auto; }
.footer-nav { display: flex; flex-wrap: wrap; justify-content: center; gap: 0.25rem; margin-bottom: 1rem; }
.footer-nav a { color: #555; text-decoration: none; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.06em; padding: 0.25rem 0.6rem; transition: color 0.15s; }
.footer-nav a:hover { color: var(--accent); }
.footer-text { color: #444; font-size: 0.8rem; margin-top: 0.75rem; }
