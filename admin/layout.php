...
function admin_header(string $page_title = '', string $active = ''): void {
    ...
    if (isset($_GET['scheme']) && in_array($_GET['scheme'], ['dark','midnight','slate','warm'])) {
...
<aside class="sidebar" id="sidebar">
  <div class="sidebar-logo">
    ...
    <button class="sidebar-toggle" id="sidebar-toggle" title="Colapsar menú" aria-label="Colapsar">
  ...
  <a href="<?= base_url() ?>/admin/editor.php?type=articles" class="sidebar-new-btn" data-label="Nuevo artículo">
    ...
    <span class="btn-new-label">Nuevo artículo</span>
  </a>
  ...
  <nav class="sidebar-nav">
    ...
    <a href="<?= base_url() ?>/admin/pages.php" class="nav-item <?= $active === 'pages' ? 'active' : '' ?>" data-label="Páginas">
      ...
      <span class="nav-label">Páginas</span>
    </a>
    ...
    <a href="<?= base_url() ?>/admin/import.php" class="nav-item <?= $active === 'import' ? 'active' : '' ?>" data-label="Importar WP">
      ...
      <span class="nav-label">Importar WordPress</span>
    </a>
    <a href="<?= base_url() ?>/admin/import_images.php" class="nav-item <?= $active === 'import_images' ? 'active' : '' ?>" data-label="Importar imágenes">
      ...
      <span class="nav-label">Importar imágenes</span>
    </a>
    <a href="<?= base_url() ?>/admin/search_replace.php" class="nav-item <?= $active === 'tools' ? 'active' : '' ?>" data-label="Buscar y reemplazar">
      ...
      <span class="nav-label">Buscar y reemplazar</span>
    </a>
    <a href="<?= base_url() ?>/admin/export.php" class="nav-item <?= $active === 'export' ? 'active' : '' ?>" data-label="Exportar">
      ...
      <span class="nav-label">Exportar contenido</span>
    </a>
  ...
  <div class="topbar">
    ...
    <div class="topbar-actions">
      ...
      <div class="scheme-dots" title="Color del panel">
        <?php
        $dot_colors = ['dark'=>'#111117','midnight'=>'#091220','slate'=>'#13151f','warm'=>'#171310'];
        foreach ($dot_colors as $s => $dc):
        ?>
        <a href="?scheme=<?= $s ?>" class="scheme-dot <?= $admin_scheme === $s ? 'active' : '' ?>"
           style="background:<?= $dc ?>;box-shadow:inset 0 0 0 1px rgba(255,255,255,0.15)"
           title="<?= ucfirst($s) ?>"></a>
        <?php endforeach; ?>
      </div>
<?php } ?>
